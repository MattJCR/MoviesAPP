 ...
 */
public class MovieAdapter_Favs extends RecyclerView.Adapter<MovieAdapter_Favs.moviesViewHolder> {
    /*
    Atributos
    */
    ...
    private MovieAdapter_Favs.OnItemClickListener listener; //Listener para cuando se haga click
    ...
    Constructor
    */
    public MovieAdapter_Favs(Context context) {
    ...
    */
    private void setListener () {
        this.listener = new MovieAdapter_Favs.OnItemClickListener() {
            @Override
    ...
    */
    ...
    public moviesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_favorites, parent, false);
    ...
    public class moviesViewHolder extends RecyclerView.ViewHolder {
        ...
        public moviesViewHolder(View itemView) {
            ...
            tvName = (TextView) itemView.findViewById(R.id.textView_favorites);
            tvImage = (ImageView) itemView.findViewById(R.id.imageView_favorites);
        }
        /*
         ...
         */
        public void bindMovie(final MovieListed movie, final MovieAdapter_Favs.OnItemClickListener listener) {
